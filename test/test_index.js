...
describe("index", function () {
  ...
  describe("maybeStartToMonitorStack", function () {
    ...
    it("should report errors", async function () {
      ...
      await index.maybeStartToMonitorStack(SAMPLE_STACK_ARN + 2).then(
    ...
    it("should monitor the same stack twice", async function () {
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn5, "test-stack-5")));
      await index.maybeStartToMonitorStack(arn5);
    ...
    it("should monitor nested stacks as well", async function () {
      ...
      cfMock
        ...
        .callsFake(
          mockCfnEvents.mockDescribeStackEvents([
            [
              {
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn7, "test-stack-7")));
  ...
  describe("startToMonitorInProgressStacks", function () {
    ...
    it("should start to monitor in-progress stacks", async function () {
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn8, "test-stack-8")));

      cfMock
        .on(DescribeStackEventsCommand, {
          StackName: arn9,
        })
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn9, "test-stack-9")));
  ...
  describe("startToMonitorDeletingStacks", function () {
    ...
    it("should start to monitor deleting stacks", async function () {
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.deleteStackEvents(arn10, "test-stack-10")));
  ...
  describe("run", function () {
    it("should start to monitor deleting stacks if stdin is empty", async function () {
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.deleteStackEvents(arn11, "test-stack-11")));
    ...
    it("should start to monitor all stacks if stdin indicates aws cloudformation deploy cmd", async function () {
      ...
      cfMock.on(DescribeStacksCommand, { StackName: arn12 }).resolves({
        Stacks: [
          {
            StackStatus: "DELETE_IN_PROGRESS",
            StackName: "test-stack-12",
      ...
      cfMock.on(DescribeStacksCommand, { StackName: arn13 }).resolves({
        Stacks: [
          {
            StackStatus: "UPDATE_IN_PROGRESS",
            StackName: "test-stack-13",
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.deleteStackEvents(arn12, "test-stack-12")));

      cfMock
        .on(DescribeStackEventsCommand, {
          StackName: arn13,
        })
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn13, "test-stack-13")));
    ...
    it("should start to monitor stacks from stdin and argv", async function () {
      ...
      cfMock.on(DescribeStacksCommand, { StackName: arn14 }).resolves({
        Stacks: [
          {
            StackStatus: "DELETE_IN_PROGRESS",
            StackName: "test-stack-14",
      ...
      cfMock.on(DescribeStacksCommand, { StackName: arn15 }).resolves({
        Stacks: [
          {
            StackStatus: "UPDATE_IN_PROGRESS",
            StackName: "test-stack-15",
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.deleteStackEvents(arn14, "test-stack-14")));

      cfMock
        .on(DescribeStackEventsCommand, {
          StackName: arn15,
        })
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn15, "test-stack-15")));
    ...
    it("should start to monitor all stacks if there is no stdin or argv", async function () {
      ...
      cfMock.on(DescribeStacksCommand, { StackName: arn16 }).resolves({
        Stacks: [
          {
            StackStatus: "UPDATE_IN_PROGRESS",
            StackName: "test-stack-16",
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn16, "test-stack-16")));
    ...
    it("should start to monitor argv only if there is no stdin", async function () {
      ...
      cfMock.on(DescribeStacksCommand, { StackName: arn17 }).resolves({
        Stacks: [
          {
            StackStatus: "UPDATE_IN_PROGRESS",
            StackName: "test-stack-17",
      ...
      cfMock
        ...
        .callsFake(mockCfnEvents.mockDescribeStackEvents(mockCfnEvents.updateStackEvents(arn17, "test-stack-17")));
